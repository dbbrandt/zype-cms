...
set :application, "zype-cms"
set :repo_url, "git@github.com:dbbrandt/zype-cms.git"

# Default branch is :master
# ask :branch, `git rev-parse --abbrev-ref HEAD`.chomp

# Default deploy_to directory is /var/www/my_app_name
set :deploy_to, "/home/precidix/srv/zype-cms"
...
# append :linked_files, "config/database.yml.example", "config/secrets.yml"
...
# No default value
#set :nginx_domains, "zype.precidix.com"
